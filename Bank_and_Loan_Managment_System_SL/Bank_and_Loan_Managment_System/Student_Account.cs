...
{
    internal class Student_Account : User
    {
        public string Email
        {
        ...
        public string ID_generater()
        {
            ...
            total = "SDA" + a + b + c + d + e + f;
            return total;
        }
        public string Student_ID { get; }
        public string Student_INS_ID;
        private string Education_Level;
        private string Current_Institution;

        public Student_Account() { }
        public Student_Account(string Email, string First_Name, string Middle_Name, string Last_Name, string Status, double balance, int National_ID, string Phone_Number, string Address, string Date_of_Birth, string Password, DateTime Account_Opening_Date, string Education_Level, string Current_Institution, string Student_INS_ID)
        {
            Student_ID = ID_generater();
            this.Email = Email;
            ...
            this.Student_INS_ID = Student_INS_ID;
