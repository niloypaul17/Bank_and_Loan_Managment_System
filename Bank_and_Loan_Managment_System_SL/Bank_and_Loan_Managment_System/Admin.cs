...
namespace Bank_and_Loan_Managment_System
{
    internal class Admin : User
    {
        ...
        public string ID_generater()
        {
            ...
            total = "MDN" + a + b + c + d + e + f + "ADM";
            return total;
        }
        public DateTime Account_Opening_Date { get; set; }

        public string Admin_ID { get; }
        private int Super_Password;

        public Admin() { }
        public Admin(string Email, string First_Name, string Middle_Name, string Last_Name, string Status, double balance, int National_ID, string Phone_Number, string Address, string Date_of_Birth, string Password, DateTime Account_Opening_Date, int Super_Password)
        {
            Admin_ID = ID_generater();
