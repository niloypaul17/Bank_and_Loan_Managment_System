...
{
    internal class Bank_Employee : User
    {
        public string Email
        {
        ...
        public Bank_Employee(string Email, string First_Name, string Middle_Name, string Last_Name, string Status, double balance, int National_ID, string Phone_Number, string Address, string Date_of_Birth, string Password, DateTime Account_Opening_Date, string Branch_Name, string Joinning_Date, string Desk_Number)
        {
            Employee_ID = ID_generater();
            this.Email = Email;
